...
#define STD_SERIAL_PORT_DEFNS \
	{ .baud_base=(5*25000000/2/16), .iomem_base=(int)0xb2e40000,.irq=2,.flags=STD_COM_FLAGS,.iomem_reg_shift=2, .io_type=SERIAL_IO_MEM}, \
	{ .baud_base=(5*25000000/2/16), .iomem_base=(int)0xb2e44000,.irq=3,.flags=STD_COM_FLAGS,.iomem_reg_shift=2, .io_type=SERIAL_IO_MEM}, 
#endif

#ifdef CONFIG_GODSON3A_780E
#define STD_SERIAL_PORT_DEFNS \
	{ .baud_base=(33000000/16), .iomem_base=(int)0xbfe001e0,.irq=58,.flags=STD_COM_FLAGS,.iomem_reg_shift=0, .io_type=SERIAL_IO_MEM}, \
	{ .baud_base=(33000000/16), .iomem_base=(int)0xbfe001e8,.irq=58,.flags=STD_COM_FLAGS,.iomem_reg_shift=0, .io_type=SERIAL_IO_MEM}, 
