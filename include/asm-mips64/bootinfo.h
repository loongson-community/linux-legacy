...
#define MACH_GROUP_ICT         23

/*gx 2005-01-10*/
#define MACH_GROUP_NB2005      24 /* ICT NB2005 boards           */
...
/*
 * Valid machtype for group ICT
 */
#define MACH_GSMB1		0
#define MACH_GSMB2		1
#define MACH_GODSONEV1		2
#define MACH_GODSONEV2A		3
#define MACH_GODSONEV2B		4
#define MACH_GODSON_SIMOS       5
#define MACH_GODSON_SIM         6
#define MACH_ICT_NB2005         7
