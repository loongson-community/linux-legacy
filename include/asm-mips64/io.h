...
#if defined(CONFIG_EV64240) || defined(CONFIG_GODSONEV2A) || defined(CONFIG_GODSON_SIM) || defined(CONFIG_GODSON_SIMOS)
#include <asm/ev64240/io.h>
#endif

#if defined(CONFIG_NB2005)||defined(CONFIG_NB2005_2ECPCI)||defined(CONFIG_DEVBD2E)||defined(CONFIG_NC2E)||defined(CONFIG_GODSON2F_BOARDS)||defined(CONFIG_GODSON2E_BOARDS) || defined(CONFIG_GODSON3A_BOARDS)
#include <asm/mach-loongson/io.h>
#endif
...
#elif defined(CONFIG_GODSON2F_LS1A_GOLDING)
static inline unsigned long bus_to_baddr(void *bus, unsigned long phy_addr)
{
#ifdef CONFIG_LS2F1A_SWIOTLB
...
static inline unsigned long baddr_to_bus(void *bus, unsigned long dma_addr)
{
#ifdef CONFIG_LS2F1A_SWIOTLB
...
#else
	return ((dma_addr>=0x80000000+0x10000000)?dma_addr:(dma_addr&0x7fffffff));
#endif
}
#define __swizzle_addr_w(port)	(port)
#elif defined(CONFIG_GODSON2F_BOARDS)||defined(CONFIG_GODSON2C_BOARDS)
#define bus_to_baddr(bus, addr)	((addr)|0x80000000)
#define baddr_to_bus(bus,addr) ((addr>=0x80000000+0x10000000)?addr:(addr&0x7fffffff))
#define __swizzle_addr_w(port)	(port)
#elif defined(CONFIG_GODSON3A_BOARDS)
#define bus_to_baddr(bus, addr)	((addr<0x10000000)?((addr)|0x80000000):addr)
#define baddr_to_bus(bus,addr) ((addr>=0x80000000 && addr<0x90000000)?(addr&0x7fffffff):addr)
#define __swizzle_addr_w(port)	(port)
#else
