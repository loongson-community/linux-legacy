...
#if    defined(CONFIG_GODSONEV2A) || defined(CONFIG_NB2005) || defined(CONFIG_NB2005_2ECPCI)||defined(CONFIG_DEVBD2E)||defined(CONFIG_NC2E)||defined(CONFIG_GODSON2F_BOARDS) || defined(CONFIG_GODSON2E_BOARDS) || defined(CONFIG_GODSON3A_BOARDS)
#define PAGE_OFFSET	0x9800000000000000UL
#define UNCAC_BASE	0x9000000000000000UL
#endif
