...
#if defined(CONFIG_GODSON_SIMOS) || defined(CONFIG_GODSON_SIM)
#include <asm/godson/godson_sim.h>
#include <asm/godson/godson_sim_int.h>
#define GODSON_SIM_SERIAL_PORT_DEFNS                   \
	   { 0, BASE_BAUD, GODSON_SIM_UART0_REGS_BASE, GODSON_SIM_INT_ISACOM1, STD_COM_FLAGS },
#else
#define GODSON_SIM_SERIAL_PORT_DEFNS
#endif
...
#define NB_SERIAL_IRQ 59
#elif defined(CONFIG_GODSON2F_SM502_GOLDING)
#define NB_SERIAL_IRQ 58
#elif defined(CONFIG_GODSON2F_BOARDS)
#define NB_SERIAL_IRQ 61
#else
#define NB_SERIAL_IRQ 43
#endif

#ifdef CONFIG_GODSON2F_DEV_SM502
#define NB_SERIAL_BASE 0xffffffffbfc803f8
#else
#define NB_SERIAL_BASE 0xffffffffbff003f8
#endif

#define STD_SERIAL_PORT_DEFNS \
	{ .baud_base=(1843200 / 16*2), .iomem_base=NB_SERIAL_BASE ,.irq=NB_SERIAL_IRQ,.flags=STD_COM_FLAGS,.io_type=SERIAL_IO_MEM}, \
	{ 0, BASE_BAUD, 0x3F8, 4, STD_COM_FLAGS },	/* ttyS1 */	\
	{ 0, BASE_BAUD, 0x2F8, 3, STD_COM_FLAGS },	/* ttyS2 */	
#endif

#ifdef CONFIG_GODSON2F_LS1A_GOLDING

#define STD_SERIAL_PORT_DEFNS \
	{ .baud_base=(5*25000000/2/16), .iomem_base=0xb2e40000,.irq=2,.flags=STD_COM_FLAGS,.iomem_reg_shift=2, .io_type=SERIAL_IO_MEM}, \
	{ .baud_base=(5*25000000/2/16), .iomem_base=0xb2e44000,.irq=3,.flags=STD_COM_FLAGS,.iomem_reg_shift=2, .io_type=SERIAL_IO_MEM}, 
#endif

#ifdef CONFIG_GODSON3A_780E
#define STD_SERIAL_PORT_DEFNS \
	{ .baud_base=(33000000/16), .iomem_base=0xbfe001e0,.irq=58,.flags=STD_COM_FLAGS,.iomem_reg_shift=0, .io_type=SERIAL_IO_MEM}, \
	{ .baud_base=(33000000/16), .iomem_base=0xbfe001e8,.irq=58,.flags=STD_COM_FLAGS,.iomem_reg_shift=0, .io_type=SERIAL_IO_MEM}, 
//	{ .baud_base=(1843200 / 16), .iomem_base=0xb80003f8,.irq=3,.flags=STD_COM_FLAGS,.iomem_reg_shift=0, .io_type=SERIAL_IO_MEM},
#endif

#ifndef STD_SERIAL_PORT_DEFNS
#define STD_SERIAL_PORT_DEFNS			\
	/* UART CLK   PORT IRQ     FLAGS        */			\
