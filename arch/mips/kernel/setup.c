...
init_arch(int argc, char **argv, char **envp, int *prom_vec)
{
	...
	clear_c0_status(ST0_CU1|ST0_CU2|ST0_CU3|ST0_SX|ST0_FR);
	set_c0_status(ST0_CU0|ST0_KX);
...
void __init setup_arch(char **cmdline_p)
{
	...
	case MACH_GROUP_MOMENCO:
		...
		break;
#endif
#ifdef CONFIG_GODSONEV2A
	case MACH_GROUP_ICT:
		godsonev2a_setup();
		break;
#endif

#if defined(CONFIG_DEVBD2E)||defined(CONFIG_NC2E)||defined(CONFIG_GODSON2F_BOARDS)||defined(CONFIG_GODSON2E_BOARDS)||defined(CONFIG_GODSON232_BOARDS)||defined(CONFIG_GODSON3A_BOARDS)
	case MACH_GROUP_ICT:
		nb2005_setup();
		break;
#endif
#if defined(CONFIG_NB2005)||defined(CONFIG_NB2005_2ECPCI)
	case MACH_GROUP_NB2005:
		nb2005_setup();
		break;
#endif
