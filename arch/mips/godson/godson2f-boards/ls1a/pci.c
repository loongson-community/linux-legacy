			    ...
			    unsigned char where, u32 *data)
{
	...
	if( (bus == 0) && (device == PCI_IDSEL_LS1A)){
		switch(access_type){
			case PCI_ACCESS_READ :
				*data = ls1a_pci_conf_read4(function, reg);
				break;
			case PCI_ACCESS_WRITE :
				ls1a_pci_conf_write4(function, reg, *data);
				break;
		}
		return 0;
	}
...
void __init pcibios_fixup(void) 
{
	 ...
	 */
	/* 0,01 0000 ,0001 01,00 0100 */
	BONITO_PCIMAP = 0x10144;
