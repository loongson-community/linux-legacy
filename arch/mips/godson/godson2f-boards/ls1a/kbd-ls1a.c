...
#define KBD_STATUS_REG		(KBD_ADDR+0x10)	/* Status register (R) */
#define KBD_CNTL_REG		(KBD_ADDR+0x10)	/* Controller command register (W) */
#define KBD_DATA_REG		(KBD_ADDR+0x0)	/* Keyboard data register (R/W) */
