...
#define P6032INT_IRQA (16+26)
#define P6032INT_IRQB (16+27)
#define P6032INT_IRQC (16+28)
#define P6032INT_IRQD (16+29)
...
static void __init godson2e_686b_func0_fixup(struct pci_dev *pdev)
{
	...
	printk("godson2e_686b_func0_fixup\n");
...
static void __init godson2e_686b_func1_fixup(struct pci_dev *pdev)
{
	...
	printk("godson2e_686b_func1_fixup\n");
...
static void __init godson2e_686b_func5_fixup(struct pci_dev *pdev)
{
	unsigned int val;
	unsigned char c;
	printk("godson2e_686b_func5_fixup\n");
