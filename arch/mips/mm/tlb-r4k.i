# 1 "arch/mips/mm/tlb-r4k.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "arch/mips/mm/tlb-r4k.c"
# 17 "arch/mips/mm/tlb-r4k.c"
...
# 5 "/work/work/loongson/sict_cpci/linux-2.4-new/include/linux/init.h" 2
...
extern int do_check_pgt_cache(int, int);
# 17 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/mmu_context.h" 2
...
void local_flush_tlb_all(void)
{
        ...
        old_ctx = (((sizeof(unsigned long) == 4) ? ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$10" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }) : ({ unsigned long __res; if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmfc0\t%0, " "$10" "\n\t" ".set\tmips0" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0" : "=r" (__res)); __res; })) & 0xff);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$2" "\n\t" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$2" "\n\t" ".set\tmips0" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0); } while (0);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$3" "\n\t" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$3" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$3" "\n\t" ".set\tmips0" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$3" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0); } while (0);
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");

        entry = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$6" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$6" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });


        while (entry < cpu_data[0].tlbsize) {




                do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (0x80000000 + entry*2*(1L << 14))); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 + entry*2*(1L << 14))); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 + entry*2*(1L << 14))); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 + entry*2*(1L << 14))); } while (0); } while (0);
                do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$0" "\n\t" : : "Jr" (entry)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$0" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entry)); } while (0);
                __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
                tlb_write_indexed();
                __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
                entry++;
        ...
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (old_ctx)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (old_ctx)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (old_ctx)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (old_ctx)); } while (0); } while (0);
                                ...
                                unsigned long end)
{
        ...
        if (((mm)->context[cpu]) != 0) {
                ...
                do { __hard_save_flags_and_cli(&(flags)); } while(0);
                size = (end - start + ((1L << 14) - 1)) >> 14;
                size = (size + 1) >> 1;
                if (size <= cpu_data[0].tlbsize/2) {
                        int oldpid = ((sizeof(unsigned long) == 4) ? ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$10" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }) : ({ unsigned long __res; if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmfc0\t%0, " "$10" "\n\t" ".set\tmips0" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0" : "=r" (__res)); __res; })) & 0xff;
                        int newpid = ((((mm))->context[(cpu)]) & 0xff);
                        ...
                        while (start < end) {
                                ...
                                do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (start | newpid)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (start | newpid)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (start | newpid)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (start | newpid)); } while (0); } while (0);
                                start += ((1L << 14) << 1);
                                __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
                                tlb_probe();
                                __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
                                idx = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$0" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$0" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
                                do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$2" "\n\t" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$2" "\n\t" ".set\tmips0" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0); } while (0);
                                do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$3" "\n\t" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$3" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$3" "\n\t" ".set\tmips0" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$3" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0); } while (0);
                                if (idx < 0)
                                        continue;

                                do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (0x80000000 + idx*2*(1L << 14))); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 + idx*2*(1L << 14))); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 + idx*2*(1L << 14))); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 + idx*2*(1L << 14))); } while (0); } while (0);
                                __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
                                tlb_write_indexed();
                                __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
                        }
                        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (oldpid)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (oldpid)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (oldpid)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (oldpid)); } while (0); } while (0);
                } else {
...
void local_flush_tlb_page(struct vm_area_struct *vma, unsigned long page)
{
        ...
        if (!vma || ((vma->vm_mm)->context[cpu]) != 0) {
                unsigned long flags;
                ...
                newpid = ((((vma->vm_mm))->context[(cpu)]) & 0xff);
                page &= ((~((1L << 14)-1)) << 1);

                do { __hard_save_flags_and_cli(&(flags)); } while(0);
                oldpid = (((sizeof(unsigned long) == 4) ? ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$10" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }) : ({ unsigned long __res; if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmfc0\t%0, " "$10" "\n\t" ".set\tmips0" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0" : "=r" (__res)); __res; })) & 0xff);
                do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (page | newpid)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (page | newpid)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (page | newpid)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (page | newpid)); } while (0); } while (0);
                __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
                tlb_probe();
                __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
                idx = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$0" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$0" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
...
void local_flush_tlb_one(unsigned long page)
{
        ...
        do { __hard_save_flags_and_cli(&(flags)); } while(0);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (page)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (page)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (page)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (page)); } while (0); } while (0);
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        tlb_probe();
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        idx = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$0" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$0" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
        ...
        if (idx >= 0) {
                ...
                do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (0x80000000 +idx*0x2000)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 +idx*0x2000)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 +idx*0x2000)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0x80000000 +idx*0x2000)); } while (0); } while (0);
                tlb_write_indexed();
        }
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (oldpid)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (oldpid)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (oldpid)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (oldpid)); } while (0); } while (0);
...
void __update_tlb(struct vm_area_struct * vma, unsigned long address, pte_t pte)
{
        ...
        pid = ((sizeof(unsigned long) == 4) ? ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$10" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }) : ({ unsigned long __res; if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmfc0\t%0, " "$10" "\n\t" ".set\tmips0" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0" : "=r" (__res)); __res; })) & 0xff;
# 273 "arch/mips/mm/tlb-r4k.c"
        do { __hard_save_flags_and_cli(&(flags)); } while(0);
        address &= ((~((1L << 14)-1)) << 1);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (address | pid)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (address | pid)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (address | pid)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (address | pid)); } while (0); } while (0);
        ...
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$2" "\n\t" : : "Jr" (((*ptep++).pte_low) >> 6)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (((*ptep++).pte_low) >> 6)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$2" "\n\t" ".set\tmips0" : : "Jr" (((*ptep++).pte_low) >> 6)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (((*ptep++).pte_low) >> 6)); } while (0); } while (0);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$3" "\n\t" : : "Jr" (((*ptep).pte_low) >> 6)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$3" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (((*ptep).pte_low) >> 6)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$3" "\n\t" ".set\tmips0" : : "Jr" (((*ptep).pte_low) >> 6)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$3" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (((*ptep).pte_low) >> 6)); } while (0); } while (0);
        ...
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (pid)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (pid)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (pid)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (pid)); } while (0); } while (0);
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
# 310 "arch/mips/mm/tlb-r4k.c"
        do { unsigned long __tmp1; __asm__ __volatile__( "__hard_restore_flags\t%0" : "=r" (__tmp1) : "0" (flags) : "memory"); } while(0);
}
# 345 "arch/mips/mm/tlb-r4k.c"
void __attribute__ ((__section__ (".text.init"))) add_wired_entry(unsigned long entrylo0, unsigned long entrylo1,
                     unsigned long entryhi, unsigned long pagemask)
{
        unsigned long flags;
        unsigned long wired;
        ...
        old_ctx = ((sizeof(unsigned long) == 4) ? ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$10" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }) : ({ unsigned long __res; if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmfc0\t%0, " "$10" "\n\t" ".set\tmips0" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmfc0\t%0, " "$10" ", " "0" "\n\t" ".set\tmips0" : "=r" (__res)); __res; })) & 0xff;
        old_pagemask = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$5" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$5" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
        wired = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$6" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$6" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$6" "\n\t" : : "Jr" (wired + 1)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$6" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (wired + 1)); } while (0);
        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$0" "\n\t" : : "Jr" (wired)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$0" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (wired)); } while (0);
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$5" "\n\t" : : "Jr" (pagemask)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$5" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (pagemask)); } while (0);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (entryhi)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entryhi)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (entryhi)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entryhi)); } while (0); } while (0);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$2" "\n\t" : : "Jr" (entrylo0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entrylo0)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$2" "\n\t" ".set\tmips0" : : "Jr" (entrylo0)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entrylo0)); } while (0); } while (0);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$3" "\n\t" : : "Jr" (entrylo1)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$3" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entrylo1)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$3" "\n\t" ".set\tmips0" : : "Jr" (entrylo1)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$3" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entrylo1)); } while (0); } while (0);
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        tlb_write_indexed();
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        ...
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (old_ctx)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (old_ctx)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (old_ctx)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (old_ctx)); } while (0); } while (0);
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$5" "\n\t" : : "Jr" (old_pagemask)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$5" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (old_pagemask)); } while (0);
        local_flush_tlb_all();
        do { unsigned long __tmp1; __asm__ __volatile__( "__hard_restore_flags\t%0" : "=r" (__tmp1) : "0" (flags) : "memory"); } while(0);
}
...
static int temp_tlb_entry __attribute__ ((__section__ (".data.init")));

__attribute__ ((__section__ (".text.init"))) int add_temporary_entry(unsigned long entrylo0, unsigned long entrylo1,
                               unsigned long entryhi, unsigned long pagemask)
{
        int ret = 0;
        unsigned long flags;
        ...
        if (--temp_tlb_entry < wired) {
                printk("<4>" "No TLB space left for add_temporary_entry\n");
                ret = -28;
                goto out;
        }

        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$0" "\n\t" : : "Jr" (temp_tlb_entry)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$0" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (temp_tlb_entry)); } while (0);
        __asm__ __volatile__(".set noreorder\n\t" "nop; nop; nop; nop; nop; nop;\n\t" ".set reorder\n\t");
        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$5" "\n\t" : : "Jr" (pagemask)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$5" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (pagemask)); } while (0);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$10" "\n\t" : : "Jr" (entryhi)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entryhi)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$10" "\n\t" ".set\tmips0" : : "Jr" (entryhi)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$10" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entryhi)); } while (0); } while (0);
        do { if (sizeof(unsigned long) == 4) do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$2" "\n\t" : : "Jr" (entrylo0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entrylo0)); } while (0); else do { if (0 == 0) __asm__ __volatile__( ".set\tmips3\n\t" "dmtc0\t%z0, " "$2" "\n\t" ".set\tmips0" : : "Jr" (entrylo0)); else __asm__ __volatile__( ".set\tmips64\n\t" "dmtc0\t%z0, " "$2" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (entrylo0)); } while (0); } while (0);
...
static void __attribute__ ((__section__ (".text.init"))) probe_tlb(unsigned long config)
{
        ...
        if ((c->processor_id & 0xff0000) == 0x000000)
                return;

        reg = ({ int __res; if (1 == 0) __asm__ __volatile__( "mfc0\t%0, " "$16" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$16" ", " "1" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
        if (!((config >> 7) & 3))
...
void __attribute__ ((__section__ (".text.init"))) r4k_tlb_init(void)
{
        u32 config = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$16" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$16" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
# 453 "arch/mips/mm/tlb-r4k.c"
        probe_tlb(config);
        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$5" "\n\t" : : "Jr" (0x00006000)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$5" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0x00006000)); } while (0);
        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$6" "\n\t" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$6" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0);
        temp_tlb_entry = cpu_data[0].tlbsize - 1;
        local_flush_tlb_all();
# 472 "arch/mips/mm/tlb-r4k.c"
                        memcpy((void *)(0x80000000 + 0x80), except_vec0_r4000, 0x80);
                        _flush_icache_range(0x80000000 + 0x80,0x80000000 + 0x100);
