# 1 "arch/mips/mm/c-r4k.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "arch/mips/mm/c-r4k.c"
# 10 "arch/mips/mm/c-r4k.c"
...
# 23 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/system.h"
# 1 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/sgidefs.h" 1
# 24 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/system.h" 2
...
# 32 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/processor.h" 2
...
# 19 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/signal.h"
typedef struct {
...
# 15 "arch/mips/mm/c-r4k.c" 2
# 1 "/work/work/loongson/sict_cpci/linux-2.4-new/include/linux/bitops.h" 1
# 11 "/work/work/loongson/sict_cpci/linux-2.4-new/include/linux/bitops.h"
...
# 16 "arch/mips/mm/c-r4k.c" 2

# 1 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/bcache.h" 1
# 17 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/bcache.h"
struct bcache_ops {
        void (*bc_enable)(void);
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void bc_enable(void)
{
        bcops->bc_enable();
}

static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void bc_disable(void)
{
        bcops->bc_disable();
}

static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void bc_wback_inv(unsigned long page, unsigned long size)
{
        bcops->bc_wback_inv(page, size);
}

static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void bc_inv(unsigned long page, unsigned long size)
{
        bcops->bc_inv(page, size);
}
# 18 "arch/mips/mm/c-r4k.c" 2
...
extern struct page *read_cache_page(struct address_space *, unsigned long,
                                filler_t *, void *);
# 16 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h" 2
# 92 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
extern void * __ioremap(phys_t offset, phys_t size, unsigned long flags);
# 135 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
extern void iounmap(void *addr);
# 170 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
extern unsigned long isa_slot_offset;
# 209 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
...
# 238 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
...
# 267 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
...
# 285 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
...
# 314 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
extern const unsigned long mips_io_port_base;
# 369 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/io.h"
...
# 27 "arch/mips/mm/c-r4k.c" 2
# 1 "/work/work/loongson/sict_cpci/linux-2.4-new/include/asm/war.h" 1
# 28 "arch/mips/mm/c-r4k.c" 2
...
# 56 "arch/mips/mm/c-r4k.c"
static void (* r4k_blast_dcache_page)(unsigned long addr);

static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void r4k_blast_dcache_page_dc32(unsigned long addr)
{
        do { if (0 && ((({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$15" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$15" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }) & 0xfffffff0) == 0x2020)) *(volatile unsigned long *)0xa0000000; if (0) __asm__ __volatile__("nop;nop;nop;nop"); } while (0);
        blast_dcache32_page(addr);
}

static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void r4k_blast_dcache_page_setup(void)
{
        unsigned long dc_lsize = cpu_data[0].dcache.linesz;
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void r4k_blast_dcache_setup(void)
{
        unsigned long dc_lsize = cpu_data[0].dcache.linesz;
...
# 108 "arch/mips/mm/c-r4k.c"
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void blast_r4600_v1_icache32(void)
{
        unsigned long flags;
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void tx49_blast_icache32(void)
{
        unsigned long start = 0x80000000;
        unsigned long end = start + cpu_data[0].icache.waysize;
        unsigned long ws_inc = 1UL << cpu_data[0].icache.waybit;
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void blast_icache32_r4600_v1_page_indexed(unsigned long page)
{
        unsigned long flags;
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void tx49_blast_icache32_page_indexed(unsigned long page)
{
        unsigned long start = page;
        unsigned long end = start + (1L << 14);
        unsigned long ws_inc = 1UL << cpu_data[0].icache.waybit;
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void r4k_blast_icache_page_setup(void)
{
        unsigned long ic_lsize = cpu_data[0].icache.linesz;
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void r4k_blast_icache_page_indexed_setup(void)
{
        unsigned long ic_lsize = cpu_data[0].icache.linesz;
        ...
        if (ic_lsize == 16)
                ...
                else if (0 && ((({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$15" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$15" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }) & 0xfffffff0) == 0x2010))
                        r4k_blast_icache_page_indexed =
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void r4k_blast_icache_setup(void)
{
        unsigned long ic_lsize = cpu_data[0].icache.linesz;
        ...
        if (ic_lsize == 16)
                ...
                if (0 && ((({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$15" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$15" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }) & 0xfffffff0) == 0x2010))
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void r4k_blast_scache_page_setup(void)
{
        unsigned long sc_lsize = cpu_data[0].scache.linesz;
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void r4k_blast_scache_setup(void)
{
        unsigned long sc_lsize = cpu_data[0].scache.linesz;
...
{
        if (!(cpu_data[0].dcache.flags & 0x00000004))
                return;
...
static void r4k_flush_cache_mm(struct mm_struct *mm)
{
        ...
        if (cpu_data[0].cputype == 10 ||
            cpu_data[0].cputype == 11 ||
            cpu_data[0].cputype == 14 ||
            cpu_data[0].cputype == 15)
                r4k_blast_scache();
}
...
static void r4k_flush_cache_page(struct vm_area_struct *vma,
                                        unsigned long page)
{
        int exec = vma->vm_flags & 0x00000004;
        ...
        if ((mm == current->active_mm) && (((*ptep).pte_low) & (1<<7))) {
                if ((cpu_data[0].dcache.flags & 0x00000004) || (exec && !(cpu_data[0].dcache.flags & 0x00000008)))
        ...
        page = (0x80000000 + (page & (dcache_size - 1)));
        if ((cpu_data[0].dcache.flags & 0x00000004) || (exec && !(cpu_data[0].dcache.flags & 0x00000008)))
                r4k_blast_dcache_page_indexed(page);
        if (exec) {
                if ((cpu_data[0].icache.flags & 0x00000002)) {
                        int cpu = 0;

                        if (((vma->vm_mm)->context[cpu]) != 0)
...
static void r4k_flush_icache_range(unsigned long start, unsigned long end)
{
        ...
        if (!(cpu_data[0].dcache.flags & 0x00000008)) {
        ...
        struct page *page)
{
        ...
        if (!(vma->vm_flags & 0x00000004))
                return;
# 447 "arch/mips/mm/c-r4k.c"
        if ((cpu_data[0].options & 0x00020000)) {
                unsigned long addr = (unsigned long) ((void *)((unsigned long) ((((page) - page_zone(page)->zone_mem_map) << 14) + page_zone(page)->zone_start_paddr) + 0x80000000UL));
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void rm7k_erratum31(void)
{
        const unsigned long ic_lsize = 32;
        unsigned long addr;


        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$28" "\n\t" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$28" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0);
        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$29" "\n\t" : : "Jr" (0)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$29" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (0)); } while (0);

        for (addr = 0x80000000; addr <= 0x80000000 + 4096; addr += ic_lsize) {
                __asm__ __volatile__ (
                        ".set noreorder\n\t"
                        ".set mips3\n\t"
                        "cache\t%1, 0(%0)\n\t"
                        ...
                        ".set\treorder\n\t"
                        :
                        : "r" (addr), "i" (0x08), "i" (0x14));
        }
}

static char *way_string[] = { ((void *)0), "direct mapped", "2-way", "3-way", "4-way",
        "5-way", "6-way", "7-way", "8-way"
};

static void __attribute__ ((__section__ (".text.init"))) probe_pcache(void)
{
        struct cpuinfo_mips *c = &cpu_data[0];
        unsigned int config = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$16" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$16" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
        ...
        case 25:
        case 28:
                icache_size = 1 << (12 + ((config & ((unsigned long)(7) << 9)) >> 9));
                c->icache.linesz = 16 << ((config & ((unsigned long)(1) << 5)) >> 5);
                c->icache.ways = 2;
                c->icache.waybit = generic_ffs(icache_size/2) - 1;

                dcache_size = 1 << (12 + ((config & ((unsigned long)(7) << 6)) >> 6));
                c->dcache.linesz = 16 << ((config & ((unsigned long)(1) << 4)) >> 4);
                c->dcache.ways = 2;
                c->dcache.waybit= generic_ffs(dcache_size/2) - 1;

                c->options |= 0x00000800;
                break;
        ...
        case 20:
        case 21:
                icache_size = 1 << (12 + ((config & ((unsigned long)(7) << 29)) >> 29));
                c->icache.linesz = 64;
                c->icache.ways = 2;
                c->icache.waybit = 0;

                dcache_size = 1 << (12 + ((config & ((unsigned long)(7) << 26)) >> 26));
                c->dcache.linesz = 32;
                c->dcache.ways = 2;
                c->dcache.waybit = 0;

                c->options |= 0x00040000;
                break;

        case 56:
                do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$16" "\n\t" : : "Jr" (config & ~((unsigned long)(1) << 13))); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$16" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (config & ~((unsigned long)(1) << 13))); } while (0);
        case 49:
                ...
                if (c->processor_id == 0x0c80U || c->processor_id == 0x0c81U ||
                    c->processor_id == 0x0c82U) {
                        config &= ~0x00000030U;
                        config |= 0x00410000U;
                        do { if (0 == 0) __asm__ __volatile__( "mtc0\t%z0, " "$16" "\n\t" : : "Jr" (config)); else __asm__ __volatile__( ".set\tmips32\n\t" "mtc0\t%z0, " "$16" ", " "0" "\n\t" ".set\tmips0" : : "Jr" (config)); } while (0);
                }
                icache_size = 1 << (10 + ((config & ((unsigned long)(7) << 9)) >> 9));
                c->icache.linesz = 16 << ((config & ((unsigned long)(1) << 5)) >> 5);
                c->icache.ways = 2;
                c->icache.waybit = generic_ffs(icache_size/2) - 1;

                dcache_size = 1 << (10 + ((config & ((unsigned long)(7) << 6)) >> 6));
                c->dcache.linesz = 16 << ((config & ((unsigned long)(1) << 4)) >> 4);
                c->dcache.ways = 2;
                c->dcache.waybit = generic_ffs(dcache_size/2) - 1;
        ...
        case 54:
                ...
                c->icache.linesz = 16 << ((config & ((unsigned long)(1) << 5)) >> 5);
                c->icache.ways = 4;
                c->icache.waybit = generic_ffs(icache_size / c->icache.ways) - 1;

                dcache_size = 1 << (12 + ((config & ((unsigned long)(7) << 6)) >> 6));
                c->dcache.linesz = 16 << ((config & ((unsigned long)(1) << 4)) >> 4);
                c->dcache.ways = 4;
                c->dcache.waybit = generic_ffs(dcache_size / c->dcache.ways) - 1;
...
# 905 "arch/mips/mm/c-r4k.c"
        if ((prid & 0xff00) == 0x0400 && (prid & 0xff) < 0x40 &&
            !(config & ((unsigned long)(1) << 17)) && c->icache.linesz != 16 &&
            (1L << 14) <= 0x8000)
        ...
        if (c->cputype != 20 && c->cputype != 21)
                if (c->dcache.waysize > (1L << 14))
                        c->dcache.flags |= 0x00000004;
        ...
        case 44:
                c->icache.flags |= 0x00000008;
                break;
        }

        printk("Primary instruction cache %ldkB, %s, %s, linesize %d bytes.\n",
               icache_size >> 10,
               (cpu_data[0].icache.flags & 0x00000002) ? "virtually tagged" : "physically tagged",
...
static int __attribute__ ((__section__ (".text.init"))) probe_scache(void)
{
        ...
        __asm__ __volatile__( "	.set	noreorder				\n" "	.set	mips3\n\t				\n" "	cache	%0, %1					\n" "	.set	mips0					\n" "	.set	reorder" : : "i" (0x08), "m" (*(unsigned char *)(begin)));
        __asm__ __volatile__( "	.set	noreorder				\n" "	.set	mips3\n\t				\n" "	cache	%0, %1					\n" "	.set	mips0					\n" "	.set	reorder" : : "i" (0x09), "m" (*(unsigned char *)(begin)));
        __asm__ __volatile__( "	.set	noreorder				\n" "	.set	mips3\n\t				\n" "	cache	%0, %1					\n" "	.set	mips0					\n" "	.set	reorder" : : "i" (0x0B), "m" (*(unsigned char *)(begin)));


        pow2 = (128 * 1024);
        tmp = 0;
        for (addr = begin + (128 * 1024); addr < end; addr = begin + pow2) {
                __asm__ __volatile__( "	.set	noreorder				\n" "	.set	mips3\n\t				\n" "	cache	%0, %1					\n" "	.set	mips0					\n" "	.set	reorder" : : "i" (0x07), "m" (*(unsigned char *)(addr)));
                __asm__ __volatile__("nop; nop; nop; nop;");
                if (!({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$28" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$28" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; }))
                        break;
                pow2 <<= 1;
        }
        do { rthal.setflags(flags); } while(0);;
        ...
        scache_size = addr;
        c->scache.linesz = 16 << ((config & ((unsigned long)(3) << 22)) >> 22);
        c->scache.ways = 1;
        c->dcache.waybit = 0;
...
static void __attribute__ ((__section__ (".text.init"))) godson2_sc_init(void)
{
        struct cpuinfo_mips *c = &cpu_data[0];
        ...
        c->options |= 0x00020000;
        return;
}


static void __attribute__ ((__section__ (".text.init"))) setup_scache(void)
{
        struct cpuinfo_mips *c = &cpu_data[0];
        unsigned int config = ({ int __res; if (0 == 0) __asm__ __volatile__( "mfc0\t%0, " "$16" "\n\t" : "=r" (__res)); else __asm__ __volatile__( ".set\tmips32\n\t" "mfc0\t%0, " "$16" ", " "0" "\n\t" ".set\tmips0\n\t" : "=r" (__res)); __res; });
        ...
        case 14:
        case 15:
                probe_scache_kseg1 = (probe_func_t) (((((int)(int) (&probe_scache)) & 0x1fffffff) | 0xa0000000));
                sc_present = probe_scache_kseg1(config);
                if (sc_present)
                        c->options |= 0x00001000;
                break;

        case 20:
        case 21:
                scache_size = 0x80000 << ((config & ((unsigned long)(7) << 16)) >> 16);
        ...
        if ((c->isa_level == 0x00000020 ||
             c->isa_level == 0x00008040) &&
            !(c->scache.flags & 0x00000001))
...
static __inline__ __attribute__((always_inline)) __attribute__((always_inline)) void coherency_setup(void)
{
        change_c0_config(7, ((5<<9) >> 9));
# 1130 "arch/mips/mm/c-r4k.c"
        switch (cpu_data[0].cputype) {
        case 9:
        case 10:
        case 11:
        ...
        case 14:
        case 15:
                clear_c0_config(((unsigned long)(1) << 3));
                break;
        }

}

void __attribute__ ((__section__ (".text.init"))) ld_mmu_r4xx0(void)
{
        ...
        memcpy((void *)(0x80000000 + 0x100), &except_vec2_generic, 0x80);
        memcpy((void *)(0xa0000000 + 0x100), &except_vec2_generic, 0x80);

        probe_pcache();
        setup_scache();


        if (c->dcache.sets * c->dcache.ways > (1L << 14))
                c->dcache.flags |= 0x00000004;
        ...
        shm_align_mask = ({ unsigned long __x = (c->dcache.sets * c->dcache.linesz - 1); unsigned long __y = ((1L << 14) - 1); __x > __y ? __x: __y; });
