...
extern int godson2_tc_init(void);
#endif
#ifdef CONFIG_ONCHIP_L2_CACHE
static void __init godson2_sc_init(void)
{
        struct cpuinfo_mips *c = &current_cpu_data;
...
static void __init setup_scache(void)
{
	...
	case CPU_LOONGSON3:
		...
		//scache_size *= 8;//gx for 3B1500 chip. must modify??
#endif
		...
		if (scache_size) c->options |= MIPS_CPU_SUBSET_CACHES;
		return;
#endif
...
#if !(defined(CONFIG_CPU_GODSON2) && defined(CONFIG_ALLOC_COLOR))
