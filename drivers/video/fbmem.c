...
extern int ls2f1afb_init(void);
extern int ls2f1afb_setup(char*);
extern int ls3afb_setup(char*);
...
#ifdef CONFIG_FB_LS2F1A
	{ "ls2f1afb", ls2f1afb_init, ls2f1afb_setup },
#endif

#ifdef CONFIG_FB_LS3A
	{ "ls3afb", NULL, ls3afb_setup },
#endif
};
