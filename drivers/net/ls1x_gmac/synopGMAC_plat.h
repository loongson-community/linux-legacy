...
#else
#define dma_map_single(dev,ptr,size,dir) pci_map_single(NULL, ptr, size, dir)
#define dma_unmap_single(dev,ptr,size,dir) pci_unmap_single(NULL, ptr, size, dir)
#endif
...
void * plat_alloc_consistent_dmaable_memory(void *, u32, dma_addr_t *);
void   plat_free_consistent_dmaable_memory (void *, u32, void *, u32);
