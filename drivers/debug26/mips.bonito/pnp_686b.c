...
void EnterMBPnP(void)
{
	...
	char confval;
	pcidev=(void *)pci_find_slot(0,(vtsb_dev<<3)|0);
...
static int PnpInit(void)
{
struct pci_dev *dev=pci_get_device(0x1106,0x0686,0);
if(dev)
{
vtsb_dev=PCI_SLOT(dev->devfn);
